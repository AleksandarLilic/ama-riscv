...
if (T4 == 0) begin: gen_comp
    ...
    csa #(.W(W), .A(1)) csa_i_l0_0 (.x(a[0]), .y(a[1]), .z(a[2]), .ckl(1'b0), .s(s_l0[0]), .c(c_l0[0]));
    csa #(.W(W), .A(1)) csa_i_l0_1 (.x(a[3]), .y(a[4]), .z(a[5]), .ckl(1'b0), .s(s_l0[1]), .c(c_l0[1]));
    csa #(.W(W), .A(1)) csa_i_l1_0 (.x(s_l0[0]), .y(c_l0[0]), .ckl(1'b0), .z(s_l0[1]), .s(s_l1[0]), .c(c_l1[0]));
    csa #(.W(W), .A(1)) csa_i_l1_1 (.x(c_l0[1]), .y(a[6]), .ckl(1'b0), .z(a[7]), .s(s_l1[1]), .c(c_l1[1]));
    csa #(.W(W), .A(1)) csa_i_l2_0 (.x(s_l1[0]), .y(c_l1[0]), .ckl(1'b0), .z(s_l1[1]), .s(s_l2), .c(c_l2));
    csa #(.W(W), .A(1)) csa_i_l3_0 (.x(s_l2), .y(c_l2), .ckl(1'b0), .z(c_l1[1]), .s(s_l3), .c(c_l3));
