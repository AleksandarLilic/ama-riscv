...
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK_BOARD }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { RST_BOARD }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
